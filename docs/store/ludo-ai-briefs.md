# Ludo AI / Higgsfield media briefs

Source: `docs/superpowers/specs/2026-08-21-ragrogue-design.md` §7.
...
Do **not** call Ludo/Higgsfield from this repo unless someone asks to generate art. Drop finished files at the paths in [`assets/placeholders/README.md`](../../assets/placeholders/README.md).
